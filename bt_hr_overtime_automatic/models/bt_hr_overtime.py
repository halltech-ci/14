    ...
    def run_overtime_scheduler(self):
        ...
        for obj in attend_signin_ids:
            if obj.check_in and obj.check_out:                            
                start_date = datetime.datetime.strptime(str(obj.check_in), DEFAULT_SERVER_DATETIME_FORMAT)                
                end_date = datetime.datetime.strptime(str(obj.check_out), DEFAULT_SERVER_DATETIME_FORMAT) 
